     ...
     public ArrayList<Fundaciones> consultarFundaciones() {
      ...
      public int guardarNuevaFundacion(Fundaciones j) {
       ...
       // String Fundacionescol = j.getFundacionescol();
        ...
        String sql = "INSERT INTO fundaciones (Nombre, Direccion, Email, Representante, URL, Telefono, Username, Password) VALUES ('"+Nombre+"', '"+Direccion+"', '"+Email+"', '"+Representante+"', '"+URL+"', '"+Telefono+"', "+Username+"', '"+Password+"') ";
